...
!(function(){
  var currUser={
      ...
      userInfo:"",
      desc : '<a class="fill-dec" href="https://passport.csdn.net/account/profile" target="_blank">编辑自我介绍，让更多人了解你<span class="write-icon"></span></a>',
              ...
              <li class="search">\
                <div class="icon on-search-icon">\
                  <div class="wrap">\
                    ...
                    <form action="http://so.csdn.net/search?ref=toolbar" method="get" target="_blank">\
                      <div class="border">\
              ...
              <li class="profile">\
                <div class="icon on-profile-icon"><img src="'+currUser.avatar+'" class="curr-icon-img">\
                  <div class="wrap clearfix">\
                    ...
                    <div class="bd">\
                      <dl class="clearfix">\
                        <dt class="pull-left img"><a target="_blank" href="https://my.csdn.net?ref=toolbar" class="avatar"><img src="'+currUser.avatar+'"></a></dt>\
                    ...
                    <div class="ft clearfix"><a target="_blank" href="https://passport.csdn.net/account/profile?ref=toolbar" class="pull-left"><span class="icon settings"></span>设置</a><a href="//passport.csdn.net/account/logout?ref=toolbar"  target="_top" class="pull-right"><span class="icon quit"></span>退出</a></div>\
                  </div>\
                </div>\
              </li>\
              <li class="apps">\
                <div class="icon on-apps-icon">\
                  ...
                  <div class="detail">\
                    <dl>\
                      ...
                      <dd> <a href="http://huiyi.csdn.net/meeting?ref=toolbar" target="_blank">会议</a></dd>\
                    </dl>\
                  </div>\
